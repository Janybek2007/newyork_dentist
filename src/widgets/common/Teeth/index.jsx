            ...
            {slidesContent.map((content, index) => (
              ...
              >
                <div className="flex items-center justify-between px-[60px]">
                  <div className="">
                    <h1 data-aos="zoom-in" data-aos-duration={300} className="text-4xl text-white font-bold">
                      {content.title}
                    </h1>
                    <h1 data-aos="zoom-in" data-aos-duration={600} className="text-2xl my-4 text-white font-bold">
                      {content.price}
                    </h1>
                    <h1 data-aos="zoom-in" data-aos-duration={900} className=" font-normal my-3 text-white">
                      {content.description}
                    </h1>
                    <button
                      onClick={() => nav('/about/clinic?tabId=2')}
                      data-aos="zoom-in"
                      data-aos-duration={1200}
                      className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500  group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-black hover:scale-110 duration-200 my-7"
                    >
            ...
            {slidesContent.map((content, index) => (
              <span
                ...
                style={{
                  ...
                  borderBottom: currentSlide === index ? '2px solid black' : 'none',
                }}
              >
                {content.title}
              </span>
